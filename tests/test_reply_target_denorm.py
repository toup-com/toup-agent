...
async def _make_engine():
    ...
    model gained `apple_refresh_token`, the copy never did, and every ORM
    insert here started failing on a column the table had never heard of. A
    hand-written schema is a second source of truth nothing keeps in sync, and
    it breaks somewhere else entirely — whenever someone adds a column.
