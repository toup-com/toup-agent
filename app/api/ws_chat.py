...
_ONBOARDING_TRIGGER = (
    ...
    "There is no brain_type and no category; the writer chooses the file.\n"
    "- Do NOT store YOUR name. Your name and personality are your identity, "
    "not facts about them; they live on the Soul page. Use the name they chose "
    "for the rest of the conversation and tell them they can change it in "
    "Settings.\n\n"
    ...
    "any always/never rules: acknowledge them and follow them, but do not call "
    "memory_store — that is your behaviour, not their biography.\n\n"
    "After gathering core info (names, goals, language, personality), summarize "
    "what you learned. Do not store a 'setup complete' note — that is "
    "bookkeeping, not a memory.\n\n"
