    ...
    async def _build_system_prompt(
        ...
        if channel in ("web", "app"):
            section_parts["media"] = (
                ...
                "1. Call `play_media(query=\"SONG NAME ARTIST\")` IMMEDIATELY — do NOT web_search first.\n"
                ...
                "6. NEVER call web_search before play_media — the tool handles search internally.\n\n"
