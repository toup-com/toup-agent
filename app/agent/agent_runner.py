...
class AgentRunner:
    ...
    async def _build_system_prompt(
        ...
        section_parts["platform_knowledge"] = (
            ...
            "- 'schedule <X>' / 'remind me at <Y>' → call `cron`\n"
            ...
            if mcp_tool_defs:
                ...
                if connectors:
                    ...
                    section_parts["skills"] = (
                        ...
                        "integrations page and try again.\" Then on the "
                        "NEXT line emit a clickable chip using the chat's "
                        "navigate chip syntax: `[[navigate:/agent/integrations]]` "
                        "(or the connector-specific form "
                        "`[[navigate:/agent/integrations/gmail]]` etc. — "
                        "use whichever the tool result gave you). The chip "
                        "renders as a real button the user can click; a raw "
                        "URL in prose is NOT clickable in this chat.\n"
