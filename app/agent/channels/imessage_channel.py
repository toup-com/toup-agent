"""
iMessage / BlueBubbles Channel Adapter — Stub implementation.

Implements the channel interface for iMessage / BlueBubbles using BlueBubbles HTTP.
...
class IMessageChannel:
    ...
    Status: STUB — structural implementation, needs BlueBubbles HTTP integration.
    """

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "imessage"
        self.display_name = "iMessage / BlueBubbles"
        self.connected = False
        self._handlers: Dict[str, Any] = {}

    async def connect(self) -> bool:
        """Connect to iMessage / BlueBubbles. Returns True on success."""
        logger.info(f"[{self.display_name}] Connecting...")
        # TODO: Implement BlueBubbles HTTP connection
        logger.warning(f"[{self.display_name}] Stub — not yet implemented")
        return False

    async def disconnect(self) -> bool:
        """Disconnect from iMessage / BlueBubbles."""
        self.connected = False
        return True
    ...
    async def get_channel_info(self, channel_id: str) -> Optional[dict]:
        ...
        return {"name": "imessage", "type": "stub", "connected": self.connected}
