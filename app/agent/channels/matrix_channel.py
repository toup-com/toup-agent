"""
Matrix / Element Channel Adapter — Stub implementation.

Implements the channel interface for Matrix / Element using matrix-nio.
...
logger = logging.getLogger("hexbrain.channel.matrix")
...
class MatrixChannel:
    ...
    Status: STUB — structural implementation, needs matrix-nio integration.
    """

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "matrix"
        self.display_name = "Matrix / Element"
        self.connected = False
        self._handlers: Dict[str, Any] = {}

    async def connect(self) -> bool:
        """Connect to Matrix / Element. Returns True on success."""
        logger.info(f"[{self.display_name}] Connecting...")
        # TODO: Implement matrix-nio connection
        logger.warning(f"[{self.display_name}] Stub — not yet implemented")
        return False

    async def disconnect(self) -> bool:
        """Disconnect from Matrix / Element."""
        self.connected = False
        return True
    ...
    async def get_channel_info(self, channel_id: str) -> Optional[dict]:
        ...
        return {"name": "matrix", "type": "stub", "connected": self.connected}
