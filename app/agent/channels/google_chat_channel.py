"""
Google Chat Channel Adapter — Stub implementation.

Implements the channel interface for Google Chat using Google Chat API.
...
logger = logging.getLogger("hexbrain.channel.google_chat")
...
class GoogleChatChannel:
    ...
    Status: STUB — structural implementation, needs Google Chat API integration.
    """

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "google_chat"
        self.display_name = "Google Chat"
        self.connected = False
        self._handlers: Dict[str, Any] = {}

    async def connect(self) -> bool:
        """Connect to Google Chat. Returns True on success."""
        logger.info(f"[{self.display_name}] Connecting...")
        # TODO: Implement Google Chat API connection
    ...
    async def get_channel_info(self, channel_id: str) -> Optional[dict]:
        ...
        return {"name": "google_chat", "type": "stub", "connected": self.connected}
