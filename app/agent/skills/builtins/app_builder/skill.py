...
class AppBuilderSkill(Skill):
    ...
    def get_system_prompt_section(self) -> Optional[str]:
        return (
            ...
            "Ask 2-4 clarifying questions in a SINGLE message. Topics to cover:\n"
            ...
            "**CRITICAL — Quick Reply Button Format:**\n"
            "Place [[option]] buttons DIRECTLY after each question on the next line. "
            "NEVER collect all buttons at the end. Each question must have its own buttons "
            "immediately below it.\n\n"
            "CORRECT format (buttons under each question):\n"
            "```\n"
            "1. **Which features?**\n"
            ...
            "\n"
            "3. **Design preference?**\n"
            "[[Dark theme]] [[Light theme]] [[Match system]]\n"
            "```\n\n"
            "WRONG format (all buttons at bottom):\n"
            "```\n"
            "1. **Which features?**\n"
            "2. **Save data?**\n"
            "3. **Design preference?**\n"
            "[[Feature A]] [[Feature B]] [[Yes]] [[No]] [[Dark]] [[Light]]\n"
            "```\n\n"
            "Always provide 2-5 buttons per question. The user picks one per question, "
            "then all answers are sent together.\n\n"
            "### Step 2: Present Plan\n"
