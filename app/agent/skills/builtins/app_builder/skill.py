...
class AppBuilderSkill(Skill):
    ...
    def get_system_prompt_section(self) -> Optional[str]:
        return (
            ...
            "- CRITICAL: Each option MUST have a [[Pick this one]] button on the line RIGHT AFTER the description. "
            "The [[...]] syntax creates clickable buttons in the UI. Without them, the user cannot click to choose. "
            "NEVER omit the [[Pick this one]] lines — they are NOT optional.\n"
