...
class AppBuilderSkill(Skill):
    ...
    def get_system_prompt_section(self) -> Optional[str]:
        return (
            ...
            "Ask clarifying questions to understand what they need. Topics to cover:\n"
            "- Main purpose / what problem the app solves\n"
            ...
            "You MUST ask only ONE question at a time and wait for the user's answer before "
            "asking the next question. NEVER ask 2 or 3 questions in the same message. "
            "Each message = one question with its options. After the user answers, "
            "ask the next question in a new message.\n\n"
            "If the user gives a detailed enough description upfront, skip to Step 2.\n\n"
            "**Quick Reply Buttons:**\n"
            "Whenever you ask a question with options, include clickable quick-reply buttons "
            "using double-bracket syntax at the END of your message:\n"
            ...
            "Always provide 2-5 buttons per question. The user can tap one OR type a custom response.\n"
